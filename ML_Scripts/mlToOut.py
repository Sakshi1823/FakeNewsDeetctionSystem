...
DEFAULTSFILEPATH = r'C:\Users\91846\OneDrive\Desktop\EDAI_2\CSVs\reputationDict.csv'
NORMALFILEPATH = r'C:\Users\91846\OneDrive\Desktop\EDAI_2\CSVs\reputations.csv'
...
def updateRep(opinions):
    for op in opinions:
        if not op.sourceName in globals.sources:
            globals.sources.update({op.sourceName : source(op.sourceName, reputation=0, articles=[], size=1)})
